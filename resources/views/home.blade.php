                ...
                <div class="stat-widget-five">
                    ...
                    <div class="stat-content">
                        <div class="text-left dib">
                            <div class="stat-text"><span class="">{{ $artikels->count() }}</span></div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="stat-widget-five">
                    ...
                    <div class="stat-content">
                        <div class="text-left dib">
                            <div class="stat-text"><span class="">{{ $kategoris->count() }}</span></div>
                        ...
                        <ul>
                            <li>
                                <div class="msg-received msg-container">
                                    <div class="avatar">
                                        <img src="{{ asset('/ElaAdmin/images/avatar/64-1.jpg')}}" alt="">
                            ...
                            <li>
                                <div class="msg-sent msg-container">
                                    <div class="avatar">
                                        <img src="{{ asset('/ElaAdmin/images/avatar/64-2.jpg')}}" alt="">
                                        <div class="send-time">11.11 am</div>
                                    </div>
                                    <div class="msg-box">
                                        <div class="inner-box">
