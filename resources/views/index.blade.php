		...
		<div class="intro-content display-table">
			<div class="table-cell">
				<div class="container">
					...
					<h1 class="intro-title mb-4">NEWS</h1>
					<p class="intro-subtitle"><span class="text-slider-items">Reporter,Journalist,Presenter</span><strong class="text-slider"></strong></p>
				...
				<div class="col-md-4">
					<div class="card card-blog">
						...
						<div class="card-body">
							...
							<h3 class="card-title"><a href="/blog/{{$data->slug}}">{!! str_limit($data->judul,50) !!}</a></h3>
